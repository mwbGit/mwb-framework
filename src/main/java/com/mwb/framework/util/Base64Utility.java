...
/* ********  O R D E R E D   B A S E 6 4   A L P H A B E T  ******** */
    ...
    public static byte[] decodeURLEncoding(String data) throws UnsupportedEncodingException {
    ...
    public static byte[] encodeBeforeURLEncoding(byte[] bytes) throws UnsupportedEncodingException {
        String data = URLEncoder.encode(new String(encode(bytes)), "UTF-8");
...
class InvalidBase64CharacterException extends IllegalArgumentException {
	...
	private static final long serialVersionUID = 619474801452732531L;
